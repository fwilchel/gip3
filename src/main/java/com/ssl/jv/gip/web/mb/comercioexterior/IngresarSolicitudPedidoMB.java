...
public class IngresarSolicitudPedidoMB extends UtilMB{
	...
	public void init(){
		...
		List<Cliente> clientes=this.maestrosEjb.consultarClientes();
		...
		this.terminosIncoterm=new ArrayList<SelectItem>();
    ...
    public void handleFileUpload(FileUploadEvent event) {
    	...
    	Hashtable<String, BigDecimal> datos=new Hashtable<String, BigDecimal>();
    	this.productos = new ArrayList<ProductoSolicitudPedidoDTO>();
    	try {
			...
			do{
				...
				if (this.solicitudCafe){
					if (pi.getProductosInventarioComext().getTipoLoteoic().getId().equals(5L)){
    ...
    public String generarSolicitudPedido(){
		...
		List<MovimientosInventarioComext> mice=new ArrayList<MovimientosInventarioComext>();
