...
public class UtilMB implements Serializable {
  ...
  /*
   * public IUsuario getUsuarioSession(){ IUsuario user = null; try{
  ...
  public boolean getErrores() {
    ...
    if (fc.getMaximumSeverity() == null) {
      return false;
    } else if (fc.getMaximumSeverity().equals(FacesMessage.SEVERITY_ERROR)
            || fc.getMaximumSeverity().equals(FacesMessage.SEVERITY_FATAL)) {
      return true;
    } else {
      return false;
    }
