	...
	public List<ProductoPorClienteComExtDTO> consultarListaProductosPorClienteCE(Long idCliente, String idsProductos, Boolean solicitudCafe){
			...
			if (solicitudCafe)
			{
				sql.append("SELECT productos_x_cliente_comext.id, "
					 ...
					 +" WHERE productos_x_cliente_comext.id_cliente = " + idCliente);
			...
			if(listado != null){
				for(Object[] objs : listado){
					...
					dto.setDblPrecioUSD(objs[4] != null ? new BigDecimal(objs[4].toString()) : null);
					dto.setDblPesoNetoProductoInventarioCE(objs[5] != null ? new BigDecimal(objs[5].toString()) : null);
					dto.setDblPesoBrutoProductoInventarioCE(objs[6] != null ? new BigDecimal(objs[6].toString()) : null);
					dto.setDblCantCajasXTendidoProductoInventarioCE(objs[7] != null ? new BigDecimal(objs[7].toString()) : null);
					dto.setDblTotalCajasXPalletProductoInventarioCE(objs[8] != null ? new BigDecimal(objs[8].toString()) : null);
					
					dto.setDblCantidad1ProductoxDocumento(objs[9] != null ? new BigDecimal(objs[9].toString()) : null);
					dto.setDblValorTotalProductoxDocumento(objs[10] != null ? new BigDecimal(objs[10].toString()) : null);
					
					dto.setDblCantidadXEmbalajeProductoInventarioCE(objs[11] != null ? new BigDecimal(objs[11].toString()) : null);
					dto.setDblPesoNetoEmbalajeProductoInventarioCE(objs[12] != null ? new BigDecimal(objs[12].toString()) : null);
					dto.setDblPesoBrutoEmbalajeProductoInventarioCE(objs[13] != null ? new BigDecimal(objs[13].toString()) : null);
