...
public class GenericDAO<T> {
  ...
  /**
   * Ejecuta la consulta nombrada que se recibe como parametro junto con un mapa
   * en donde la llave seria el nombre del parametro en la consulta :PARAMETRO1
   * y el valor asociado a la llave seria el dato enviado a la consulta.
   *
   * @param nombreConsulta
   *          Nombre de la consulta nombrada a ser ejecutada en el contexto de
   *          persistencia
   * @param parametros
   *          Mapa de parámetros utilizado para realizar la búsqueda en el
   *          contexto de persistencia
   * @param <T>
   *          generico
   * @return listado de entidades resultado de la consulta en el contexto de
   *         persistencia
   ...
   *
   * @param consultaJPQL
   *          Cadena de consulta JPQL a ser ejecutada en el contexto de
   *          persistencia
   * @param parametros
   *          mapa de parámetros utilizado para realizar la búsqueda en el
   *          contexto de persistencia
