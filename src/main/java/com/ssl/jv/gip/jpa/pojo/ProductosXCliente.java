...
public class ProductosXCliente implements Serializable {
  ...
  public static final String NQ_BUSCAR_PRODUCTOS_X_CLIENTE_Y_PUNTO_VENTA_ACTIVOS = "ProductosXCliente.buscarProductosXClienteActivos";
