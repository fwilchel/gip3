...
public class GenerarRequerimientoExportacionMB extends UtilMB {
   ...
   */
  private List<DocumentoRequerimientoExportacionDTO> listaDocumentos = new ArrayList<>();

  private List<ModalidadEmbarque> listaModalidadEmbarque = new ArrayList<>();
  ...
  private List<SelectItem> listaCertificado = new ArrayList<>();
  ...
  private List<ComextRequerimientoexportacionDTO> listareqxproducto = new ArrayList<>();
  ...
  public void terminoIncoterms() {
    ...
    } else if (!incotermDespacho.equals("DAP") || !incotermDespacho.equals("DDP")) {
      direccionEntrega = "";
      zipCode = "";
      telefonoEmail = "";
      contacto = "";
  ...
  public void guardarRequerimientoExportacion(ActionEvent ae) {
    ...
    try {
      ...
      listareqxproducto = new ArrayList<>();
  ...
  public void consultarReqxproducto() {
    ...
    if (selectedMarcacionEspecial == true) {
      ...
      listareqxproducto = comercioEjb.crearMarcacionEspecial(strDocs);
    } else if (selectedMarcacionEspecial == false) {
      //permite listar la consulta de MarcacionEspecial sin diligenciar 
