...
public class GenerarFacturaMB extends UtilMB {
   ...
   */
	...
	public void seleccionarRemision(Documento documento) {
		...
		} else if (getTipoFacturaSeleccionado() == ConstantesTipoDocumento.SOLICITUD_PEDIDO
				&& (getRemisionSeleccionada().getSitioEntrega() == null || !remisionSeleccionada.getSitioEntrega().equals("CS"))) {
