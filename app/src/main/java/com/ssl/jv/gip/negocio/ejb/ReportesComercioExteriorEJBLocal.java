...
public interface ReportesComercioExteriorEJBLocal {
  ...
  /**
   * Metodo que consulta los documentos de las liquidaciones de Costos
   * Logísticos ordenados DESC por consecutivo
   *
  ...
  /**
   * Metodo que consulta los productos de cafe de una LE
   *
   * @author Diego Poveda - Soft Studio Ltda.
   * @email dpoveda@gmail.com
   * @phone 3192594013
