...
public class ClienteDAO extends GenericDAO<Cliente> implements ClienteDAOLocal {
  ...
  public List<Cliente> consultarActivosPorUsuario(String idUsuario) {
    Query query = em.createNamedQuery(Cliente.CLIENTE_ACTIVO_FIND_BY_USUARIO);
  ...
  public List<Cliente> consultarActivosInternacionales() {
    /*
     * Map <String, Object> p=new HashMap<String, Object>(); p.put("activo",
     * true); return buscarPorConsultaJPQL(Cliente.CLIENTE_ACTIVO_INTERNACIONAL,
     * p);
     */
