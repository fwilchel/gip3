...
import com.ssl.jv.gip.negocio.dao.LiquidacionDocumentoDAOLocal;
...
@Stateless
@LocalBean
public class ReportesComercioExteriorEJB implements
		ReportesComercioExteriorEJBLocal {
	...
	@EJB
	private LiquidacionDocumentoDAOLocal liquidacionDocumentoDAO;
	...
	public List<Documento> consultarFacturasExportacionReimprimir(
		...
		return documentoDAO.buscarPorConsultaNombrada(
				Documento.BUSCAR_DOCUMENTOS_FX_REIMPRIMIR, parametros);
	}
	...
	public InstruccionEmbarqueDTO consultarDetalleInstruccionEmbarque(Long id) {
		...
		InstruccionEmbarqueDTO documento = terminosTransporteDAO
				.obtenerDetalleInstruccionEmbarque(id);
		Map<String, Object> parametros;
		...
		List<Long> tipoMercadeo = null;
		{
			...
			List<Object[]> listaIds = terminosTransporteDAO
					.buscarPorConsultaNativa(DOCUMENTOS_POR_TERMINO_TRASPORTE,
							parametros);
			if (listaIds != null) {
				for (Object[] obj : listaIds) {
					if (obj[1].equals(true)) {
						...
						tipoSolicitudCafe
								.add(((BigInteger) obj[0]).longValue());
					} else {
		...
		}
		{
			...
			if (tipoSolicitudCafe != null || tipoMercadeo != null) {
				...
				listaLotes = terminosTransporteDAO.buscarPorConsultaNativa(
						query.toString(), LoteTerminoTransporteDTO.class,
						parametros);
	...
	public List<ProductosInventario> consultarListadoProductosReporteVentasCE(
		...
		return productoInventarioDAO
				.consultarListadoProductosReporteVentasCE(parametros);
	}
	...
	public List<DocumentoXNegociacion> consultarDocumentoXNegociacionxDocumento(
			Long idDocumento) {
		return documentoXNegociacionDAO
				.consultarDocumentoXNegociacionPorIdDocumento(idDocumento);
	}
	...
	public List<DocumentoCintaTestigoMagneticaDTO> consultarDocumentosReporteCintaTestigoMagnetica(
		...
		return documentoDAO
				.consultarDocumentosReporteCintaTestigoMagnetica(parametros);
	}
	...
	public List<DocumentoXLotesoic> consultarPorConsecutivoDocumento(
		...
		return documentoLotesOICDAO
				.consultarPorConsecutivoDocumento(consecutivoDocumento);
	}

	@Override
	public List<ReporteProduccionDTO> consultarProductosReporteProduccion(
			Map<String, Object> parametros) {
		return productosXDocumentoDAO.buscarPorConsultaNativa(
				ReporteProduccionDTO.BUSCAR_PRODUCTOS_REPORTE_PRODUCCION,
				ReporteProduccionDTO.class, parametros);
	}
	...
	public List<ProductosInformeTiendaLineaDTO> consultarProductosPorListaEmpaque(
		...
		return productosXDocumentoDAO.buscarPorConsultaNativa(
				ProductosInformeTiendaLineaDTO.PRODUCTOS_POR_LISTA_EMPAQUE,
				ProductosInformeTiendaLineaDTO.class, parametros);
	}
	...
	public List<CuentaContableComprobanteInformeDiarioDTO> consultarCuentaContableComprobanteInformeDiarioFX(
		...
		return documentoDAO
				.buscarPorConsultaNativa(
						CuentaContableComprobanteInformeDiarioDTO.CUENTA_CONTABLE_COMPROBANTE_INFORME_DIARIO,
						CuentaContableComprobanteInformeDiarioDTO.class,
						parametros);
	}
	...
	public Documento consultarFacturaFXReimprimir(Long id) {
		...
		if (id == null) {
			throw new IllegalArgumentException(
					"El parametro <<observacionDocumento>> es requerido");
		} else {
			Map<String, Object> parametros = new HashMap<>();
			parametros.put("id", id);
			return documentoDAO.buscarRegistroPorConsultaNombrada(
					Documento.BUSCAR_DOCUMENTO_FX_REIMPRIMIR_BY_ID, parametros);
		}
	}
	...
	public String consultarConsecutivoOrdenFacturaFX(Long id) {
		...
		if (id == null) {
			...
			Map<String, Object> parametros = new HashMap<>();
			parametros.put("id", id);
			return documentoDAO.buscarRegistroPorConsultaNativa(
					Documento.BUSCAR_CONSECUTIVO_ORDEN_FACTURA_FX, parametros);
		}
	}
	...
	public List<ComextRequerimientoexportacion> consultarComextRequerimientoExportacionConsecutivo(
		...
		if (id == null) {
			throw new IllegalArgumentException(
					"El parametro <<idDocumento>> es requerido");
		} else {
			Map<String, Object> parametros = new HashMap<>();
			parametros.put("id", id);

			return comextRequerimientoExportacionDAO
					.buscarPorConsultaNombrada(
							ComextRequerimientoexportacion.BUSCAR_DOCUMENTO_POR_CONSECUTIVO,
							parametros);
		}
	}
	...
	public List<ComextRequerimientoexportacion> consultarComextRequerimientoExportacion() {
		// TODO Auto-generated method stub
		return comextRequerimientoExportacionDAO.buscarPorConsultaNombrada(
				ComextRequerimientoexportacion.FIND_ALL, null);
	...
	public ComextRequerimientoexportacion consultarComextRequerimientoExportacionDetalle(
		...
		if (id == null) {
			...
			return comextRequerimientoExportacionDAO
					.buscarRegistroPorConsultaNombrada(
							ComextRequerimientoexportacion.BUSCAR_DOCUMENTO_POR_CONSECUTIVO,
							parametros);

			// return
			// documentoDAO.buscarRegistroPorConsultaNombrada(Documento.BUSCAR_DOCUMENTO_FX_REIMPRIMIR_BY_ID,
			// parametros);
	...
	public List<LiquidacionDocumento> consultarDocumentosCL() {
		return (List<LiquidacionDocumento>)liquidacionDocumentoDAO.findAll();
	}
}
