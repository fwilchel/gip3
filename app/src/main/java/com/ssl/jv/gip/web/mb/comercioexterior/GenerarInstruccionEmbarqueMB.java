...
public class GenerarInstruccionEmbarqueMB extends UtilMB {
  ...
  private static final Logger LOGGER = Logger.getLogger(GenerarInstruccionEmbarqueMB.class);
  ...
  public void guardarInstruccionEmbarque(ActionEvent ae) {
    ...
    try {
      ...
      LOGGER.error(e);
      this.addMensajeError(AplicacionMB.getMessage("InstruccionEmbarqueError_Crear", language));
    }
  }
  ...
  public void setListadoDocumentos(List<DocumentoInstruccionEmbarqueDTO> listadoDocumentos) {
  ...
  public void setListadoDocumentoLotes(List<DocumentoPorLotesInstruccionEmbarqueDTO> listadoDocumentoLotes) {
  ...
  public void setStrObservacionTerminosTransporte(String strObservacionTerminosTransporte) {
  ...
  public void setStrObservacionTerminosTransporte2(String strObservacionTerminosTransporte2) {
  ...
  public SelectItem[] getListaAgenteAduana() {
    if (listaAgenteAduana == null) {
      ...
      for (int i = 0; i < lista.size(); i++) {
        listaAgenteAduana[i] = new SelectItem(new Long(((AgenteAduana) lista.get(i)).getId()), new String(((AgenteAduana) lista.get(i)).getNombre()));
      }
    }
  ...
  public SelectItem[] getListaAgenteAduana2() {
    if (listaAgenteAduana2 == null) {
      ...
      for (int i = 0; i < lista.size(); i++) {
        listaAgenteAduana2[i] = new SelectItem(new Long(((AgenteAduana) lista.get(i)).getId()), new String(((AgenteAduana) lista.get(i)).getNombre()));
      }
    }
  ...
  public SelectItem[] getListaModalidadEmbarque() {
    if (listaModalidadEmbarque == null) {
      ...
      for (int i = 0; i < lista.size(); i++) {
        listaModalidadEmbarque[i] = new SelectItem(new Long(((ModalidadEmbarque) lista.get(i)).getId()), new String(((ModalidadEmbarque) lista.get(i)).getDescripcion()));
      }
    }
  ...
  public SelectItem[] getListaPais() {
    ...
    if (listaPais == null) {
      ...
      // "));
      for (int i = 0; i < lista.size(); i++) {
        listaPais[i] = new SelectItem(new String(((Pais) lista.get(i)).getId()), new String(((Pais) lista.get(i)).getNombre()));
  ...
  public void cambioPais() {
    if (strIdPais != null && !strIdPais.equals("")) {
      ...
      for (int i = 0; i < lista.size(); i++) {
        listaCiudad[i] = new SelectItem(new Long(((Ciudad) lista.get(i)).getId()), new String(((Ciudad) lista.get(i)).getNombre()));
      }
    } else {
