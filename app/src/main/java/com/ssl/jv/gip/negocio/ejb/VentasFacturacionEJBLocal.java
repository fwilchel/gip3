...
public interface VentasFacturacionEJBLocal {
	...
	List<ProductoFacturaDirectaDTO> consultarProductoFacturaDirecta(String consecutivoDocumento);

	List<Documento> consultarDocumento(Map<String, Object> parametros, Long[] idEstados);

	// List<ProductoFacturaDirectaDTO> consultarProductoFacturaDirecta(String
	// strConsecutivoDocumento);
	/**
	 * Metodo que consulta los documentos tipo factura en estado pendientes por
	 * recibir y puede filtrar por el consecutivo
	 *
	 ...
	 */
	Documento crearVentaDirecta(Documento documento, LogAuditoria auditoria, List<ProductosXDocumento> productos);
	...
	/**
	 * Metodo que consulta los documentos que son ordenes de despacho por
	 * observacion.
	 *
	 * @param observacion
	 * @return
	 ...
	 * @return
	 */
	Documento generarFactura(Documento factura, List<ProductosXDocumento> listaProductos, Documento remisionRelacionada, LogAuditoria auditoria) throws Exception;
